<?php
class TntspeedUpCache {
    private $expire         = CACHE_EXPIRE;
    private $lang           = 'en';
    private $currency       = 'USD';
    private $addcomment     = true;                            
    private $wrapcomment    = false;
    private $end_flush      = false;  
    ...
    public function __construct() {
        ...
        $this->cachefolder=DIR_CACHE. 'speedup_page_cache/';
        $svar=$this->s_data;
    ...
    public function sget_session(){
        $session = null;
        $octlversion = $this->octlversion();
        if($octlversion >= 3020){

        }else if($octlversion >= 3010){
            
        }else if($octlversion >= 2300){

        }else if($octlversion >= 2200){
            require_once(DIR_SYSTEM.'library/session.php');
            $session = new Session();
            $session->start();
            $this->s_data = $session->data;
        }
    }
