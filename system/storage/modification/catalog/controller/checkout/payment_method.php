...
class ControllerCheckoutPaymentMethod extends Controller {
	public function index() {
		...
		if (isset($this->session->data['payment_address'])) {
			...
			if (strpos($this->session->data['shipping_method']['code'], 'speedy.') !== false) {
				if (!empty($this->session->data['speedy']['cod'])) {
					$method_data = array("speedy_cod" => $method_data["speedy_cod"]);
				} else {
					if (strpos($this->session->data['shipping_method']['code'], 'speedy') !== false) {
						unset($method_data["cod"]);
					}
					unset($method_data["speedy_cod"]);
				}
			} else {
				unset($method_data["speedy_cod"]);
			}
